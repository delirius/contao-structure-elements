...
$GLOBALS['TL_DCA']['tl_content']['fields']['strc_title'] = [
	'exclude'   => true,
	'search'    => true,
	'filter'    => true,
	'sorting'   => true,
...
$GLOBALS['TL_DCA']['tl_content']['fields']['strc_color'] = [
	'exclude'   => true,
	'search'    => true,
	'filter'    => true,
	'sorting'   => true,
...
$GLOBALS['TL_DCA']['tl_content']['fields']['strc_element'] = [
	'exclude'     => true,
	'search'      => true,
	'filter'      => true,
	'sorting'     => true,
	'inputType'   => 'text',
	'explanation' => 'htmltag',
	'eval'        => ['mandatory' => true, 'maxlength' => 255, 'helpwizard' => true, 'tl_class' => 'w50 clr'],
	'sql'         => "varchar(255) NOT NULL default ''",
];

// Interne Felder — werden nur programmatisch gesetzt, nie im Backend angezeigt
$GLOBALS['TL_DCA']['tl_content']['fields']['strc_pairing'] = [
	'eval' => ['doNotCopy' => true, 'doNotShow' => true],
	'sql'  => "int unsigned NOT NULL default '0'",
];

$GLOBALS['TL_DCA']['tl_content']['fields']['strc_pairing_update'] = [
	'eval' => ['doNotShow' => true],
	'sql'  => "int unsigned NOT NULL default '0'",
];

$GLOBALS['TL_DCA']['tl_content']['fields']['strc_element_attribute'] = [
	'exclude'   => true,
	'inputType' => 'listWizard',
	'eval'      => ['tl_class' => 'clr', 'maxlength' => 128],
	'sql'       => 'blob NULL',
];

$GLOBALS['TL_DCA']['tl_content']['fields']['strc_content'] = [
	'exclude'   => true,
	'inputType' => 'text',
	'eval'      => ['maxlength' => 255, 'tl_class' => 'w50 clr'],
	'sql'       => "varchar(255) NOT NULL default ''",
